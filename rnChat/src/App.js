...
import { YellowBox, Text, View, ScrollView, TouchableOpacity, TextInput, Keyboard } from 'react-native';
...
class App extends Component {
  ...
  onReceiveMessage = data => this.setState({
    textList: [
      ...this.state.textList,
      { text: data },
    ],
  ...
  render() {
    return (
      <View style={container.style}>
        ...
        <TouchableOpacity style={button.container} onPress={this.onButtonPress} disabled={this.state.input === ''}>
